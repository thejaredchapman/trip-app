...
export const TRAVELERS: Traveler[] = [
  ...
  },
  {
    ...
    presentDays: [1, 2, 3, 4, 5, 6, 7, 8],
    totalDays: 8,
    soloDays: 'Days 6–8: Camden, Museums, Greenwich (all 4 travelers)',
    avatarInitials: 'ER',
    emoji: '🇺🇸',
    emergencyContact: {
      name: 'TBD — Update Before Trip',
...
export const ITINERARY: DayPlan[] = [
  {
    ...
    accommodation: 'Airbnb — 96 Kingsland Rd 4, London E2 8DP',
    accommodationContact: { url: 'https://www.airbnb.com/rooms/1129505888246550256', address: '96 Kingsland Road 4, Greater London, England E2 8DP, United Kingdom' },
    activities: [
      {
  ...
  },
  {
    ...
    dateShort: 'May 20',
    city: 'London',
    subtitle: 'British Museum, Culture & Dracula',
    travelerIds: ['jared', 'elias', 'devonte', 'jordan'],
    accommodation: 'Airbnb — 96 Kingsland Rd 4, London E2 8DP',
    accommodationContact: { url: 'https://www.airbnb.com/rooms/1129505888246550256', address: '96 Kingsland Road 4, Greater London, England E2 8DP, United Kingdom' },
    activities: [
      ...
      {
        id: 'a3-4', time: '3:00 PM', title: 'Sky Garden', description: 'Free rooftop garden with panoramic London views', icon: '🌿', category: 'sightseeing',
        contact: { phone: '+44-20-7337-2344', url: 'https://skygarden.london', address: '20 Fenchurch St, London EC3M 3BY, UK' },
      },
      {
        id: 'a3-5', time: '5:00 PM', title: 'Brick Lane', description: 'Street art, curry houses & vintage shops in East London', icon: '🎨', category: 'shopping',
        contact: { url: 'https://www.visitbricklane.org', address: 'Brick Ln, London E1 6RF, UK' },
      },
      {
  ...
  },
  {
    ...
    dateShort: 'May 21',
    city: 'London → Paris',
    subtitle: 'Road Trip to Paris',
    travelerIds: ['jared', 'elias', 'devonte', 'jordan'],
    accommodation: 'Paris Hotel (TBD)',
    notes: 'Road trip ~6–7 hours total driving via Eurotunnel. Book Le Shuttle in advance at eurotunnel.com (~35 min crossing).',
    activities: [
      {
        id: 'a4-0', time: '7:00 AM', title: 'Pick Up Rental Car & Depart London', description: 'Head southeast on M2/A2 toward Canterbury (~1.5 hrs)', icon: '🚗', category: 'transport',
        contact: { address: 'Central London, UK' },
      },
      {
        id: 'a4-1', time: '8:30 AM', title: 'Canterbury Cathedral', description: 'UNESCO World Heritage Site — stunning medieval cathedral, seat of the Archbishop of Canterbury', icon: '⛪', category: 'culture',
        contact: { phone: '+44-1227-762-862', url: 'https://www.canterbury-cathedral.org', address: 'Cathedral House, 11 The Precincts, Canterbury CT1 2EH, UK' },
      },
      {
        id: 'a4-2', time: '10:00 AM', title: 'White Cliffs of Dover', description: 'Iconic chalk cliffs overlooking the English Channel — short walk to the viewpoint', icon: '🏔️', category: 'nature',
        contact: { phone: '+44-1304-202-756', url: 'https://www.nationaltrust.org.uk/the-white-cliffs-of-dover', address: 'Langdon Cliffs, Upper Rd, Dover CT16 1HJ, UK' },
      },
      {
        id: 'a4-3', time: '11:30 AM', title: 'Eurotunnel Le Shuttle (Folkestone → Calais)', description: 'Drive your car onto the train — 35 min under the English Channel', icon: '🚄', category: 'transport',
        contact: { phone: '+44-8443-35-35-35', url: 'https://www.eurotunnel.com', address: 'Eurotunnel Terminal, Folkestone CT18 8XX, UK' },
      },
      {
        id: 'a4-4', time: '1:00 PM', title: 'Lunch in Boulogne-sur-Mer', description: 'Charming walled old town with great seafood restaurants — first taste of France', icon: '🦪', category: 'food',
        contact: { address: 'Ville Fortifiée, 62200 Boulogne-sur-Mer, France' },
      },
      {
        id: 'a4-5', time: '3:00 PM', title: 'Amiens Cathedral', description: 'Tallest Gothic cathedral in France — UNESCO World Heritage Site, even larger than Notre-Dame', icon: '⛪', category: 'culture',
        contact: { phone: '+33-3-22-71-60-50', url: 'https://www.cathedrale-amiens.fr', address: '30 Pl. Notre Dame, 80000 Amiens, France' },
      },
      {
        id: 'a4-6', time: '4:30 PM', title: 'Drive to Paris', description: 'Final stretch on A1 autoroute (~2 hrs) into central Paris', icon: '🚗', category: 'transport',
        contact: { address: 'A1 Autoroute, France' },
      },
      {
        id: 'a4-7', time: '7:00 PM', title: 'Arrive in Paris & Dinner in Le Marais', description: 'Check in and celebrate arriving with Parisian neighborhood dining', icon: '🥖', category: 'food',
